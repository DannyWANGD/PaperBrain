...
| [[SemanticContact_Fields_for_CategoryLevel_Generalizable_Tactile_Tool_Manipulation]] | 7.0 | `#domain/3d_perception` `#domain/embodied_ai` `#domain/multimodal_perception` `#domain/reinforcement_learning` `#domain/robot_manipulation` `#domain/sim2real` | 2026-02-14 |
| [[Soft_Contamination]] | 7.0 | `#domain/embodied_ai` `#domain/vla` `#method/benchmark` `#method/foundation_model` | 2026-02-12 |
