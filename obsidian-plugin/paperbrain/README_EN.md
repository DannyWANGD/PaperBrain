...
The plugin is desktop-only because it starts local processes. Plugin `0.6.3`
...
| --- | --- | --- |
| 0.6.3 | Initial installer pins 0.3.7; compatible 0.3.x wheels can be updated | 1.5.0 or later, desktop |
