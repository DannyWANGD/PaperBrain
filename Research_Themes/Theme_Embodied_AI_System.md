...
FoundationModel --> VLA
VLA --> CrossEmbodiment
CrossEmbodiment --> ZeroShotPolicy
WorldModel --> RLPlanner
WorldModel --> VideoDiffusion
VideoDiffusion --> DiffusionPolicy
DiffusionPolicy --> RealTimeControl
RLPlanner --> LongHorizonPlanning
```
