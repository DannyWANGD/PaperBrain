...
- [ ] **2026-06-04**: New paper [[AffordVLA]] discusses *visual intermediate reasoning*. Innovation: "Internalizing task-conditioned affordance as learnable tokens that decode masks and directly condition action generation in a tightly coupled VLA framework."
- [ ] **2026-06-06**: New paper [[WLA]] discusses *vla with visual reasoning*. Innovation: "Proposes a unified autoregressive model that predicts both high-level textual subtasks and low-level physical dynamics to guide action synthesis, enabling optional world prediction for test-time scaling."
- [ ] **2026-06-09**: New paper [[StableVLA]] discusses *vla with visual reasoning*. Innovation: "Proposes an Information Bottleneck Adapter that selectively filters visual noise without extra data, improving VLA robustness by 30% on average."
- [ ] **2026-06-09**: New paper [[ARVLA]] discusses *vla with visual reasoning*. Innovation: "Introduces a standalone autoregressive action expert with persistent memory and a re-anchoring mechanism that mathematically accounts for perception staleness, enabling asynchronous vision-language conditioning and continuous context-aware action generation."
- [ ] **2026-06-12**: New paper [[EmbodiedR15]] discusses *vla with visual reasoning*. Innovation: "A unified Embodied Foundation Model with integrated reasoning, planning, and self-correction, trained with multi-task balanced RL and automated data pipelines, achieving strong zero-shot real-robot performance."